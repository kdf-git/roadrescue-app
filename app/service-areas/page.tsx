    ...
    <>
      ...
      <section className="py-16 px-6 max-w-5xl mx-auto">
        ...
        <div className="text-center mt-12">
          ...
          <a href="tel:+19737940012" className="inline-block bg-red-600 hover:bg-red-700 text-white font-bold px-8 py-4 rounded-full shadow transition-colors">
            Call +1 (973) 794-0012 — 24/7
          </a>
        </div>
      </section>
      <Footer />
